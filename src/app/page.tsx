        ...
        <div className=" mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16 ">
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className="text-lg leading-8">
              <p className="">
                "The case feels durable and I even got a compliment on the design. Had the case for two and a half months  now and <span className=" p-0.5 bg-slate-900 text-white">the image is super clear</span>, on the case I had before, the image started fasding into yellow-ish color after a couple weeks. Love it.
                "
              </p>
          ...
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className="text-lg leading-8">
              <p className="">
                "I usually keep my phone together with my keys in my pocket  and that led to some pretty heavy scratchmarks on all of my last phone case. This one, besides a barely not noticeable scretch on the corner,{' '} <span className=" p-0.5 bg-slate-900 text-white">looks brand new after about half a year</span>. I dig it.
                "
              </p>
            ...
            <img src="/users/user-5.jpg" className=" rounded-full h-12 w-12 object-cover" alt="user" />
              <div className="flex flex-col">
                <p className="font-semibold">Dheeraj</p>
                <div className="flex gap-1.5 items-center text-zinc-600">
                  <Check className="h-4 w-4 stroke-[3px] text-green-600"/>
                  <p className="text-sm">Verified Purchase</p>
